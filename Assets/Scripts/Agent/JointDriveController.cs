...
public class JointDriveController : MonoBehaviour
{
    ...
    public void SetupBodyPart(Transform transform)
    {
        var bodyPart = new BodyPart
        {
            ...
            contactChecker = transform.GetComponent<ContectChecker>(),
        };

        bodyPart.rigidbody.maxAngularVelocity = _maxAngularVelocity;
        if (!bodyPart.contactChecker) bodyPart.contactChecker = transform.AddComponent<ContectChecker>();
        bodyPart.contactChecker.agent = GetComponent<Agent>();
